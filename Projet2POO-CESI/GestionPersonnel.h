...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->groupBox1->Size = System::Drawing::Size(234, 194);
			...
			this->labelPersoAdresse->Location = System::Drawing::Point(3, 68);
			...
			// textBoxPersoAdresse
			// 
			this->textBoxPersoAdresse->Location = System::Drawing::Point(6, 84);
			this->textBoxPersoAdresse->Name = L"textBoxPersoAdresse";
			this->textBoxPersoAdresse->Size = System::Drawing::Size(100, 20);
			this->textBoxPersoAdresse->TabIndex = 4;
			// 
			// dateTimePickerDateEmbauche
			// 
			this->dateTimePickerDateEmbauche->Location = System::Drawing::Point(6, 134);
			...
			this->labelDateEmbauche->Location = System::Drawing::Point(6, 118);
			...
			// buttonEmbaucher
			// 
			this->buttonEmbaucher->Location = System::Drawing::Point(80, 165);
