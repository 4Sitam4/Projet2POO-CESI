...
namespace Projet2POOCESI {
	...
	public:
		...
		{
			InitializeComponent();
			this->ClientSize = System::Drawing::Size(170, 80);
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->groupBox2->Location = System::Drawing::Point(362, 13);
			this->groupBox2->Name = L"groupBox2";
			this->groupBox2->Size = System::Drawing::Size(312, 381);
			...
			// textBox5
			// 
			this->textBox5->Location = System::Drawing::Point(74, 75);
			...
			this->label6->Location = System::Drawing::Point(115, 56);
			...
			this->label5->Location = System::Drawing::Point(6, 275);
			...
			// textBox4
			// 
			this->textBox4->Location = System::Drawing::Point(9, 237);
			...
			this->label4->Location = System::Drawing::Point(6, 218);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(166, 136);
			...
			this->label1->Location = System::Drawing::Point(6, 117);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(7, 136);
