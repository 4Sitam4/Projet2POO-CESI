...
//suppr
void NS_Comp_Catalogue::Catalogue::supprimerProduit(System::String^ ref, System::String^ designation, System::String^ stock, System::String^ reapprovisionnement, System::String^ prix, System::String^ TVA) {
